		...
		return (
			<div>
				...
				<div className="options">
					...
					<div className="option">
			            <Button id="exportToCSV" onClick={this.handleClick.bind(this, 'csv')}>Export to CSV</Button>
			        </div>
			        <div className="option">
			            <Button id="exportToTSV" onClick={this.handleClick.bind(this, 'tsv')}>Export to TSV</Button>
			        </div>
			        <div className="option">
			            <Button id="exportToXML" onClick={this.handleClick.bind(this, 'xml')}>Export to XML</Button>
			        </div>
				</div>
			</div>
		);
