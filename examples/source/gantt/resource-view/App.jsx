...
class App extends React.Component {
	...
	handleChange(event) {
		this.ganttchart.current.groupByResources = event.detail.value;
	}
		...
		return (
			<div>
				...
				<GanttChart ref={this.ganttchart} id="ganttChart" dataSource={this.dataSource} taskColumns={this.taskColumns} treeSize={this.treeSize}
					durationUnit={this.durationUnit} hideResourcePanel={this.hideResourcePanel} groupByResources={this.groupByResources}
