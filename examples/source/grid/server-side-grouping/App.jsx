	...
	render() {
		return (
			<div>
			    ...
			    <Grid
			     grouping={this.grouping} dataSource={this.dataSource} columns={this.columns} sorting={this.sorting} filtering={this.filtering} pager={this.pager} paging={this.paging} id="grid"></Grid>
			        <br />
			        <br />
			        	<h3>SQL Query</h3>
			        <div id="query"></div>
