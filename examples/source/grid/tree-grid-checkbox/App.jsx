			...
			<div>
				...
				<div className="options">
					...
					<div className="option">
						<CheckBox  checked id="check" onChange={this.handleCheckChange.bind(this)}>Show Checkboxes</CheckBox>
					</div>
					<div className="option">
						<CheckBox  checked id="tristateCheck" onChange={this.handleTristateCheckChange.bind(this)}>Has Three States</CheckBox>
					</div>
					<div className="option">
						<CheckBox checked id="showHideCheck" onChange={this.handleShowHideCheckChange.bind(this)}>Show/Hide Root Checkboxes</CheckBox>
					</div>
				</div>
			</div>
		);
