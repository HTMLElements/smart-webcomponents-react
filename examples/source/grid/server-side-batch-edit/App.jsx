		...
		return (
			<div>
			    <div className="demo-description">
			        ...
			        used.</div>
			    <Grid appearance={this.appearance} selection={this.selection} editing={this.editing} sorting={this.sorting} dataSource={this.dataSource} columns={this.columns}  id="grid"></Grid>
			    <br />
			    <br />
			    	<h3>SQL Query</h3>
			    <div id="query"></div>
