		...
		return (
			<div>
			    <div className="demo-description">
			        ...
			        used.</div>
			    <Grid dataSource={this.dataSource} editing={this.editing} columns={this.columns} sorting={this.sorting} appearance={this.appearance} selection={this.selection}  id="grid"></Grid>
			    <br />
			    <br />
			    	<h3>SQL Query</h3>
			    <div id="query"></div>
