		...
		return (
			<div>
			    <div className="demo-description">
			        ...
			        used.</div>
			    <Grid   rowDetail={this.rowDetail} onRowInit={this.onRowInit} onRowDetailInit={this.onRowDetailInit} appearance={this.appearance} sorting={this.sorting} dataSource={this.dataSource} columns={this.columns} id="grid"></Grid>
			    <br />
			    <br />
			    	<h3>SQL Query</h3>
			    <div id="query"></div>
