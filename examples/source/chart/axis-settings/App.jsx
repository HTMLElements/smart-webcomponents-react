			...
			<div>
				...
				<div className="options">
					<table>
						...
						<tr>
							<td>Left padding:
			                    <Slider id="sliderValueAxisLeftPadding" min="0"
						...
						<tr>
							<td>Right padding:
			                    <Slider id="sliderValueAxisRightPadding" min="0"
									max="50" value="0" coerce labelsVisibility="none" ticksVisibility="major"
						...
						<tr>
							<td>Labels angle:
			                    <Slider id="sliderValueAxisAngle" min="0" max="360"
						...
						<tr>
							<td>Top padding:
			                    <Slider id="sliderXAxisTopPadding" min="0" max="50"
									value="0" coerce labelsVisibility="none" ticksVisibility="major"
						...
						<tr>
							<td>Bottom padding:
			                    <Slider id="sliderXAxisBottomPadding" min="0"
									max="50" value="0" coerce labelsVisibility="none" ticksVisibility="major"
						...
						<tr>
							<td>Labels angle:
			                    <Slider id="sliderXAxisAngle" min="0" max="360"
									value="0" coerce labelsVisibility="none" ticksVisibility="major"
