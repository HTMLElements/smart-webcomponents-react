		...
		return (
			<div>
				...
				<Window ref={this.regularMapWindow} pinned modal
			        ...
			        <section>
			            <Map query={this.query1} apiKey={this.apiKey} mapType={this.mapType1}></Map>
			        </section>
			    </Window>
				<Window ref={this.satelliteMapWindow} pinned modal 
			        ...
			        <section>
			            <Map query={this.query2} apiKey={this.apiKey} mapType={this.mapType2}></Map>
			        </section>
			    </Window>
				<Window ref={this.customMapWindow} pinned modal 
			        ...
			        <section>
			            <Map query={this.query3} apiKey={this.apiKey} mapType={this.mapType3}></Map>
			        </section>
			    </Window>
			</div>
		);
	        ...
	        window.onload = function() {
			    ...
			    <template id="footerTemplateSatellite">
			        <div>
			            ...
			            <Button  className="success outlined medium raised" id="closeSatelliteMap"> <span className="primary">
			    ...
			    <template id="footerTemplateCustom">
			        <div>
			            ...
			            <Button  className="raised" id="closeCustomMap"> <span className="primary">
...
*/
	/*
		...
		template2.innerHTML= ' <div><Button  className="success medium raised" id="saveLocationSatelliteMap"> <span className="primary">Save Location <i className="material-icons">location_on</i></span></Button><Button  className="success outlined medium raised" id="closeSatelliteMap"> <span className="primary">  Close <i className="material-icons">close</i></span></Button></div>';
		template3.innerHTML = ' <div><Button  className="raised" id="saveLocationCustomMap"> <span className="primary">Save Location <i className="material-icons">location_on</i></span></Button><Button className="raised" id="closeCustomMap"> <span className="primary">Close <i className="material-icons">close</i></span></Button></div>'
