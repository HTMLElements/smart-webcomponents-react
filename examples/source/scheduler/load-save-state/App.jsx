			...
			<div>
				...
				<div className="options">
					...
					<div className="option">
						<Button  id="saveState" onClick={this.saveState.bind(this)}>Save State</Button>
					</div>
					<div className="option">
						<Button  id="loadState" onClick={this.loadState.bind(this)}>Load State</Button>
					</div>
					<div className="option">
						<Button  id="clearState" onClick={this.clearState.bind(this)}>Reset</Button>
					</div>
				</div>
			</div>
		);
