	...
	render() {
		...
		<div>
			...
			<div className="options">
				...
				<br/>
				<h4>Square Width:</h4>		
				<NumberInput ref={this.squareWidth} id="square-width" className="option" value={12} min={8} max={30}></NumberInput>
				<br/>
				<h4>Display Label:</h4>
				<CheckBox id="label-display" className="option">Visible</CheckBox>
				<br/>
				<h4>Label Color:</h4>		
