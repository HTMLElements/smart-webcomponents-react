...
export default function App() {
	...
	useEffect(() => {
		...
		editor.current.value = getEditorValue(editor.current.locale)
	}, [])
	...
	function handleRadioButtonChange(locale) {

		editor.current.locale = locale;
		editor.current.value = getEditorValue(locale);
		...
		<div>
			...
			<div className="options">
				...
				<div className="option">
					<RadioButton onChange={handleRadioButtonChange.bind(null, 'en')}>EN</RadioButton>
					<RadioButton onChange={handleRadioButtonChange.bind(null, 'de')} checked>DE</RadioButton>
					<RadioButton onChange={handleRadioButtonChange.bind(null, 'it')}>IT</RadioButton>
				</div>
			</div>
		</div>
	)
