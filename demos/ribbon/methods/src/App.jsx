...
function App() {
  ...
  // Functions for adding tab, group, and item
  const addTab = () => {
    ...
    if (addTabBtnRef.current) addTabBtnRef.current.disabled = true;
  };
  ...
  const addGroup = () => {
    ...
    ribbon.addGroup(currentTab, newGroup);
    if (addGroupBtnRef.current) addGroupBtnRef.current.disabled = true;
  };
  ...
  const addItem = () => {
    ...
    ribbon.addItem(currentTab, 0, newItem);
    if (addItemBtnRef.current) addItemBtnRef.current.disabled = true;
  };
    ...
    <div>
      <div className="smart-demo-container">
        <div className="document-container">
          <Ribbon ref={ribbonRef} dataSource={dataSource} fileMenu={fileMenu} rightToLeft />
          <div className="document">
            <div>
              Tabs, Groups and Items can be added as an HTML node or an Object<br />
              <div>
                <Button ref={addTabBtnRef} onClick={addTab}>Add new Tab</Button>
                <Button ref={addGroupBtnRef} onClick={addGroup}>Add Group to current tab</Button>
                <Button ref={addItemBtnRef} onClick={addItem}>Add Item to first group of selected tab</Button>
              </div>
            </div>
          </div>
        </div>
