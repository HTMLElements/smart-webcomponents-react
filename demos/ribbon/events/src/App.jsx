			...
			<div>
				<div className="smart-demo-container">
					<div class="document-container">
							<Ribbon ref={this.ribbon} dataSource={this.dataSource} fileMenu={this.fileMenu}
							onClick={this.clickHandler} onChange={this.changeHandler} onSelect={this.selectionHandler}
							onDialogLauncherClick={this.dialogLaunchHandler} onExpand={this.expandHandler} onCollapse={this.collapseHandler}>
							</Ribbon>
							<div class="document">
									Events Log:
									<ul id="events"></ul>
