...
const columns = [
  ...
  },
  {
    ...
    tooltipRenderer: (id, dataField, value, formattedValue, data) =>
      `Progress is\xa0<b>${formattedValue}%</b>`
  },
  {
    label: "Status",
    width: 180,
    ...
    options: [
      ...
      { color: "#64B5F6", label: "Blocked", value: "Blocked" },
      { color: "#4DB6AC", label: "Review", value: "Review" },
  ...
  },
  {
    ...
    dataField: "Tags",
    template: "tags",
    filterEditor: { template: "multi" },
    templateSettings: { multiSelect: true },
    options: [
