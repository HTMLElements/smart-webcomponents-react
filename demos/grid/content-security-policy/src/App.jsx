...
const Demo = () => {
	...
	const columns = [
        ...
        },
        {
            ...
            tooltipRenderer: (id, dataField, value, formattedValue, data) => `Task Name is\xa0<b>${formattedValue}</b>`
        },
        {
            label: "Assignee", width: 250, dataField: "Assignee", "template": "tags", "icon": "jqx-icon-user", "options": [
        ...
        {
            label: "Start Date", width: 200, dataField: "Start Date", "dataType": "date", cellsFormat: 'M/d/yyyy', template: 'startDate', relationField: 'Due Date',
            filterEditor: {
                condition: 'RANGE'
            }
        },
        {
            label: "Due Date", width: 200, dataField: "Due Date", "dataType": "date", cellsFormat: 'M/d/yyyy', template: 'dueDate', relationField: 'Status',
            templateSettings: {
        ...
        },
        {
            ...
            tooltipRenderer: (id, dataField, value, formattedValue, data) => `Progress is\xa0<b>${formattedValue}%</b>`
        },
        {
            label: "Status", width: 230, dataField: "Status", "template": "tags", "options": [
        ...
        {
            label: "Priority", width: 200, dataField: "Priority", "template": "tags", "options": [
        ...
        {
            label: "Tags", dataField: "Tags", template: "tags", filterEditor: { template: 'multi' }, templateSettings: { multiSelect: true },
            options: [
    ...
    const dataSource = [
        ["", "Design mockups", "Jane Smith", "2025-10-01", "2025-12-01", 30, "In Progress", "High", "Frontend, Design"],
		...
		<div className="viewport">
			<div className="demo-description">
			 <h1>Content Security Policy</h1>
				<p>
				  This example uses a Content Security Policy meta tag to show that the
				  grid works with CSP
				</p>
			</div>
			<Grid
