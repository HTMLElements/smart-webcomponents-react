...
export default function App() {
	...
	const columns = [
	  { label: 'id', dataField: 'id', dataType: 'number', columnGroup: 'name', allowEdit: false, width: 130 },
		{
			label: 'First Name', dataField: 'firstName', columnGroup: 'name', width: 200
		},
		{ label: 'Last Name', dataField: 'lastName', columnGroup: 'name', width: 200 },
		{label: 'Product Name', dataField: 'productName', editor: 'textarea', template: 'richText', width: 250},
		{ label: 'Checklist', dataField: 'checklist', columnGroup: 'product', dataType: 'string',  template: 'checklist',
			editor: {
					template: '<jqx-multi-combo-input></jqx-multi-combo-input>',
					settings: {
						inputTagsMode: 'one',
						readonly: true,
						allowItemsAdd: true,
						allowItemsRemove: true
					},
...
comboBox.style.height = '100%';
					...
					getValue: function () {
						...
						const items = comboBox.dataSource.map((item) => {
							...
							return { text: item.label, completed: selectedItem !== undefined };
						});
