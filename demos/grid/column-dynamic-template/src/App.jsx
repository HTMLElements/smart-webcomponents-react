	...
	const columns = [{
		...
		template: (formatObject) => {
			if (!formatObject.template) {
				...
				const salesValue = `
					<span 
						style="padding: 4px 10px; border-radius: 10px; color: #fff; background: ${getChipColor()};"
					>
				...
				const categoryValue = `
					<span 
						style="margin-left: 10px; padding: 4px 10px; border-radius: 10px; color: #fff; background: ${getChipColor()};"
					>
	...
	},
	{
		...
		template: (formatObject) => {
			...
			if (!formatObject.template) {
				...
				<span 
					style="margin-right: 7px; padding: 4px 18px; border-radius: 10px 5px; color: #fff; background: ${color}";
				>
				 	${formatObject.value}
				</span>`;
			} else {
