...
export default function App() {
	...
	const columns = [
		...
		{
			label: 'Pie', dataField: 'points', template: 'sparklines', templateSettings: {
				type: 'pie',
				max: 100,
				colorFunction(value: number) {
					...
					return 'var(--smart-primary)';

				}
			}, columnGroup: 'product', dataType: 'string', width: 150
		},
		{
			label: 'Column', dataField: 'columnPoints', template: 'sparklines', templateSettings: {
				type: 'column',
				max: 100,
				colorFunction(value: number) {
					const colors = ['#D50000', '#F4511E', '#F6BF26', '#33B679'];
		...
		{
			label: 'Bar', dataField: 'barPoints', template: 'sparklines', templateSettings: {
				type: 'bar',
				max: 100,
				colorFunction(value: number) {
					const colors = ['#D50000', '#F4511E', '#F6BF26', '#33B679'];
		...
		{
			label: 'Line', dataField: 'linePoints', template: 'sparklines', templateSettings: {
				type: 'line',
				max: 100,
				colorFunction(value: number) {
					const colors = ['#D50000', '#F4511E', '#F6BF26', '#33B679'];
