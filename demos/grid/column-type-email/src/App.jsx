...
const RowDetail = (
	...
	return (
		<div className="details-dialog">
			...
			<div className="column-info">
				<a href={`mailto:${rowData.projectLeadEmail || ''}`}>{rowData.projectLeadEmail || ''}</a>
			</div>
			<div className="column-info">
...
export default function App() {
	...
	},
	{
		...
		template: function (formatObject) {
			...
			formatObject.template =
				`<span style="margin-left: 7px; padding: 4px 18px; border-radius: 10px 5px; color: #fff; background: ${color}";>${formatObject.value}</span>`;
		}
	},
	{
		label: 'Done',
	...
	},
	{
		...
		template: function (formatObject) {
			formatObject.template =
				`<span style="margin-right: 7px; margin-left: 10px; padding: 4px 18px; border-radius: 10px 5px; background: #E9EEF9";>${formatObject.value}</span>`;
		}
	},
	{
		label: 'Project team',
