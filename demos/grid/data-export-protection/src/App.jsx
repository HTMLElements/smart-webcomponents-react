...
const Demo = () => {
    ...
    // Update grid's dataExport.protectSheet when password changes
    useEffect(() => {
        if (gridRef.current) {
            gridRef.current.dataExport.protectSheet = password.length > 0 ? { password } : true
        }
    }, [password]);
    ...
    // Grid columns with custom templates
    const columns = [
             {
            label: 'Name',
            dataField: 'name',
    ...
    return (
        <div className="viewport" style={{ padding: 20 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'row' }}>
                <div style={{ flex: 1 }}>
                    <Grid
                        ...
                        style={{ width: 'calc(100% - 300px)', maxWidth: 1000, height: 600 }}
                    />
                </div>
                <div className="options" style={{ width: 300, marginLeft: 24 }}>
                    <div className="caption"></div>
                    <div className="option" style={{ marginBottom: 16 }}>
                        <p>Worksheet password (optional)</p>
                        <Input
                            id="password"
                            value={password}
