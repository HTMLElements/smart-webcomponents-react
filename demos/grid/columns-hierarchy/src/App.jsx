...
// DataSourceSettings with mapChar and dataFields
...
const Demo = () => {
    ...
    // Columns definition with cellsRenderer converted to React render functions
    const columns = [
        {
            label: "City",
            dataField: "City",
        ...
        },
        {
            ...
            cellsRenderer: (row, column, value) => {
                ...
                return (
                    <>
                        <span style={{ fontSize: 24, marginRight: 5 }}>{icon}</span> {value}
                    </>
                );
            },
        },
        {
            ...
            cellsRenderer: (row, column, value) => {
                ...
                return (
                    <>
                        <span style={{ fontSize: 24, marginRight: 5 }}>{temperatureIcons}</span> {value}°C
                    </>
                );
            },
        },
        {
            ...
            columnGroup: "Measurement Details",
            // The grid will handle date formatting automatically
        },
        {
            label: "Certified",
            dataField: "Certified",
