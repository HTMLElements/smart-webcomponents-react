  ...
  return (
    <div>
      <div id="container" className="module">
        ...
        <span className="smart-badge smart-badge-info">Success</span>
        <span className="smart-badge smart-badge-success">Info</span>
        <span className="smart-badge smart-badge-warning">Warning</span>
        <span className="smart-badge smart-badge-danger">Danger</span>
        <h1>Pills</h1>
        <span className="smart-badge smart-badge-light smart-badge-pill">Light</span>
        <span className="smart-badge smart-badge-dark smart-badge-pill">Dark</span>
        <span className="smart-badge smart-badge-info smart-badge-pill">Info</span>
        <span className="smart-badge smart-badge-success smart-badge-pill">Success</span>
        <span className="smart-badge smart-badge-warning smart-badge-pill">Warning</span>
        <span className="smart-badge smart-badge-danger smart-badge-pill">Danger</span>
      </div>
    </div>
  );
};
