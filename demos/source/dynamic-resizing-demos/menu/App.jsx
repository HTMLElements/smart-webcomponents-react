	...
	render() {
		return (
			<div>
			    ...
			    <Slider  id="resizeSlider" min="100" max="1000" value="1000"
			    orientation="horizontal" scale-position="near" show-unit unit="px"></Slider>
			    <br />
			     <h3>Minimize icon:</h3>
			    <RadioButton  checked>Hamburger icon <em>(default)</em>
			    </RadioButton>
			    <RadioButton>Custom icon</RadioButton>
			    <RadioButton>Text</RadioButton>
			    <br />
			    <br />
			    <Menu id="menu" className="animation" minimize-width="150" drop-down-append-to="body">
