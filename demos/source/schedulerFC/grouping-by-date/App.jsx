...
export default function App() {
	...
	const handleRadioButtonChange = (value) => {
		scheduler.current.groupOrientation = value
	}
		...
		<div>
			...
			<div className="options">
				<div className="option">
					...
					<RadioButton checked onChange={handleRadioButtonChange.bind(null, 'horizontal')}>Horizontal</RadioButton>
					<RadioButton onChange={handleRadioButtonChange.bind(null, 'vertical')}>Vertical</RadioButton>
				</div>
			</div>
		</div>
	)
