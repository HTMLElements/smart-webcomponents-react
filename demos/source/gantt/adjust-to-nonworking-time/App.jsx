...
class App extends React.Component {
	...
	handleClick() {
		...
		this.ganttChart.current.adjustToNonworkingTime = !this.ganttChart.current.adjustToNonworkingTime;
		this.button.current.innerHTML = `Click to ${this.ganttChart.current.adjustToNonworkingTime ? 'Disable' : 'Enable'}`;
		...
		return (
			<div>
				<GanttChart
					ref={this.ganttChart}
					id="gantt"
					adjustToNonwokringTime={this.adjustToNonwokringTime}
