...
class App extends React.Component {
	...
	handleChangeRadioButtonChange(value, event) {

		if (event.detail.value) {
			this.ganttchart.current.resourceTimelineView = value;
		}
	...
	handleReady() {
		...
		const customResourceHeaderRoot = ReactDOM.createRoot(document.querySelector('.custom-resource-panel-header'));
		customResourceHeaderRoot.render(
			<>
				...
				<div className="timelineHeader" id="timelineHeaderTemplateContainer">
					<RadioButton onChange={this.handleChangeRadioButtonChange.bind(this, 'hours')} checked value="hours">Hours per week</RadioButton>
					<RadioButton onChange={this.handleChangeRadioButtonChange.bind(this, 'tasks')} value="tasks">Tasks per week</RadioButton>
				</div>
	...
	init() {
		...
		template.innerHTML = `<div class="custom-resource-panel-header"></div>`;

		document.body.appendChild(template);

		this.ganttchart.current.resourcePanelHeaderTemplate = template.id;
		...
		return (
			<div>
				...
				<GanttChart
					...
					resourcePanelSize={this.resourcePanelSize}
