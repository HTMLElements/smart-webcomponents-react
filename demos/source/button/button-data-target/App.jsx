		...
		return (
			<div>
			    ...
			    <div className="collapse" id="collapseExample">
			        <div className="card card-body">Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry
			    ...
			    <div className="tab-content" id="myTabContent">
					...
					<div>
						...
						<RadioButton checked name="Cappucino" data-target="#radioGroup">Cappucino
						</RadioButton>
						...
						<input onchange="window.log.innerHTML = this.value" id="radioGroup" type="hidden"/>
						<div id="log"></div>
					</div>
					...
					<div>
						...
						<br />
						<RadioButton checked name="Volvo" data-target="#radioGroup2">Volvo
						</RadioButton><br />
					...
					<div>
						Value is stored in a visible input field below the radio buttons.
						<br />
						<CheckBox checked name="Volvo" data-target="#checkGroup">Volvo
						</CheckBox><br />
