...
Supported Browsers: Chrome, Firefox, Safari, Edge, Opera
	...
	return (
		<div>
			<Editor ref={editor} id="editor" editMode={editMode} toolbarItems={toolbarItems} value={value}>
				<div>
			...
			<div className="options">
				...
				<div className="option">
					<Button id="exportToMD" onClick={handleExport.bind(this, 'md')}>Export to Markdown</Button>
				</div>
				<div className="option">
