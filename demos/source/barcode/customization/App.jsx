	...
	render() {
		...
		<div>
			...
			<div className="options">
				...
				<ColorPicker ref={this.backgroundColor} id="background-color" className="option" value="white"></ColorPicker>
				<br/>
				<h4>Line Color:</h4>		
				<ColorPicker ref={this.lineColor} id="line-color" className="option" value="black"></ColorPicker>
				<br/>
							<h4>Line Width:</h4>		
				<NumberInput ref={this.lineWidth} id="line-width" className="option" value={4} min={1} max={10}></NumberInput>
				<br/>
							<h4>Line Height:</h4>		
				<NumberInput ref={this.lineHeight} id="line-height" className="option" value={50} min={25} max={100}></NumberInput>
				<br/>
							<h4>Label Color:</h4>		
				<ColorPicker ref={this.labelColor} id="label-color" className="option" value="black"></ColorPicker>
				<br/>
							<h4>Label Font Size:</h4>		
				<NumberInput ref={this.labelFontSize} id="label-font-size" className="option" value={14} max={60} min={10}></NumberInput>
				<br/><br/>
