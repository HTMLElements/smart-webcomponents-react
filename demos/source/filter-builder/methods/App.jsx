	...
	render() {
		return (
			<div>
			    ...
			    <Window id="valueToString"></Window>
			    <div id="filterQueryBox">
			        <TextBox id="addPosition" placeholder="Item id"></TextBox>
			        <br />
			         <h3>Group</h3>
			        <TextBox id="addGroupRule" placeholder="Group Rule"></TextBox>
			        <br />
			        <Button  id="addGroupButton">Add Group</Button>
			        <br />
			        <Button  id="updateGroupButton">Update Group</Button>
			        <br />
			        <Button  id="removeGroupButton">Remove Group</Button>
			        <hr />
			         <h3>Condition</h3>
			        <DropDownList  id="addConditionField" placeholder="Field Name"
			        selection-mode="zeroOrOne"></DropDownList>
			        <br />
			        <DropDownList id="addConditionRule" placeholder="Rule"
			        selection-mode="zeroOrOne"></DropDownList>
			        <br />
			        <TextBox id="addConditionValue" placeholder="Value"></TextBox>
			        <br />
			        <Button  id="addConditionButton">Add Condition</Button>
			        <br />
			        <Button  id="updateConditionButton">Update Condition</Button>
			        <br />
			        <Button id="removeConditionButton">Remove Condition</Button>
			        <br />
			        <Button id="toStringButton">Value To String</Button>
			    </div>
			</div>
		);
	}
