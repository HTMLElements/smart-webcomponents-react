		...
		return (
			<div>
				...
				<div className="options">
					...
					<div className="option">
						<Button  id="showMessage" onClick={this.showMessage.bind(this)}>Show Message</Button>
						<Button  id="hideLastMessage" onClick={this.hideLastMessage.bind(this)}>Hide Last Message</Button>
						<Button  id="hideAllMessages" onClick={this.hideMessages.bind(this)}>Hide All Messages</Button>
					</div>
				</div>
			</div>
		);
