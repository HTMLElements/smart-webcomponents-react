		...
		return (
			<div>
				...
				<div className="options">
					...
					<div className="option">
						<Button  id="insert" className="demoButton" onClick={this.handleInsertClick.bind(this)}>Insert at index</Button>
					</div>
					<div className="option">
						<Button  id="remove" className="demoButton" onClick={this.handleRemoveClick.bind(this)}>Remove at index</Button>
					</div>
					<div className="option">
						<Button  id="update" className="demoButton" onClick={this.handleUpdateClick.bind(this)}>Update at index</Button>
					</div>
				</div>
			</div>
		);
