...
export default function App() {
    ...
    const getKanbanDataItems = (locale = 'en') => {
    ...
    return (
        <div>
            <div className="demo-description">10 000 tasks are loaded in the Kanban</div>
            <Kanban
                collapsible={collapsible} editable={editable} dataSource={dataSource}
                taskActions={taskActions} taskDue={taskDue} taskSubTasks={taskSubtasks}
                taskComments={taskComments} currentUser={currentUser} taskProgress={taskProgress}
                columns={columns}
            >
            </Kanban>
        </div>
