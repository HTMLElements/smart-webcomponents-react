...
import "smart-webcomponents-react/source/modules/smart.dateinput";
import "smart-webcomponents-react/source/modules/smart.numberinput";
  ...
  render() {
    return (
      <div>
        ...
        <Kanban ref={this.kanban} {...this.kanbanSettings}>
        </Kanban>
      </div>
    );
  }
