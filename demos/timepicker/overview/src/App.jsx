...
class App extends React.Component {
	...
	componentDidMount() {
		...
		<template id="templateWithButtons">
			<Button  className="flat">CANCEL</Button>
			...
			<div className="smart-demo-container">
				...
				<div id="materialPicker">
					<section id="timePickers">
						...
						<div className="module">
							<div>
								<TimePicker footer footer-template="templateWithButtons"></TimePicker>
							</div>
						</div>
						<br />
						<br />
						<div className="module">
							<div>
								<TimePicker footer footer-template="templateWithButtons"
						...
						<div className="module">
							<TimePicker view="landscape" footer footer-template="templateWithButtons"></TimePicker>
						</div>
						<br />
						<br />
						<div className="module">
							<TimePicker view="landscape" footer footer-template="templateWithButtons"
								selection="minute"></TimePicker>
						</div>
					</section>
				</div>
