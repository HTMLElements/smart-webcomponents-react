...
(function runProcess() {
    ...
    for (let demo of tempDemos) {
        ...
        for (let i = 0; i < allDemos.length; i++) {
            ...
            if (
                demo.indexOf('server-side-mysql-php') >= 0
                || demo.indexOf('server-side-paging-sorting-filtering-mysql-php' >= 0)
            ) {
                const commonFolder = './dist/' + demo + '/common';
                ...
                fs.copyFileSync('./src/common/grid_data.php', commonFolder + '/grid_data.php');
            }
        }
    }
