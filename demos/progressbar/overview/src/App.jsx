...
const App = () => {
  useEffect(() => {
    ...
    let hoverArea = document.getElementById('hover-area'),
      ...
      circularProgressBar2 = progressBars[2], // likely an error: circularProgressBar2 = progressBars[2] is same as linearProgressBar3
    ...
    const intervalId = setInterval(function () {
      ...
      if (linearProgressBar1) linearProgressBar1.value += value;
      if (linearProgressBar2) linearProgressBar2.value += value;
      if (circularProgressBar1) circularProgressBar1.value += value;
      if (circularProgressBar2) circularProgressBar2.value += value;
      if (linearProgressBar1 && linearProgressBar1.value >= linearProgressBar1.max) {
        isPaused = true;
    ...
    return () => {
      ...
      // Optional: Remove event listeners here if needed for cleanup
    };
  }, []);
