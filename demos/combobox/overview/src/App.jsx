...
const App = () => {
	return (
		<div>
			...
			<ComboBox dropDownPosition="bottom" selectedIndexes={[0]} label="Phone" selectionMode="one" className="combos1">
			...
			<ComboBox dropDownPosition="bottom" selectedIndexes={[0]} label="Email" selectionMode="one" className="combos1">
				<ListItem>Work</ListItem>
				<ListItem>Mobile</ListItem>
				<ListItem>Home</ListItem>
			</ComboBox>
			...
			<ComboBox dropDownPosition="bottom" selectedIndexes={[0]} label="Address" selectionMode="one" className="combos1">
				<ListItem>Home</ListItem>
				<ListItem>Mobile</ListItem>
				<ListItem>Work</ListItem>
			</ComboBox>
			...
			<div className="module">
				<p>smartComboBox has a variety of selection modes allowing single or multiple
					item selection.</p>
			</div>
