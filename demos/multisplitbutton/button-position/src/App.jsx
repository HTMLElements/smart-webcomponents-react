...
const App = () => {
    const multisplitbutton = useRef();

    const handleChange = useCallback((position) => {
        if (multisplitbutton.current) {
            multisplitbutton.current.dropDownButtonPosition = position;
        }
    }, []);
    ...
    return (
        <div>
            <div id="comboBoxContainer">
                <MultiSplitButton ref={multisplitbutton} buttonsDataSource={['Send', 'Save', 'Save As']}>
                ...
                <div className="options">
                    ...
                    <div className="option">
                        <RadioButton onChange={() => handleChange('left')}>
                            Left
                        </RadioButton>
                        <RadioButton onChange={() => handleChange('right')} checked>
                            Right
                        </RadioButton>
                    </div>
                </div>
