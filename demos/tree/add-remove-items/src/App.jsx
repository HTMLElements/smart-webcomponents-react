		...
		return (
			<div>
				...
				<div className="options">
					...
					<Button  id="addBefore" className="demoButton" onClick={this.handleAddBeforeClick.bind(this)}>Add before "Z"</Button>
					<br />
					<br />
					<Button  id="addAfter" className="demoButton" onClick={this.handleAddAfterClick.bind(this)}>Add after "3"</Button>
					<br />
					<br />
					<Button  id="addTo" className="demoButton" onClick={this.handleAddToClick.bind(this)}>Add to "Letters"</Button>
					<br />
					<br />
					<Button  id="addGroupTo" className="demoButton" onClick={this.handleAddGroupToClick.bind(this)}>Add to
			            <br />"Greek letters"</Button>
					<br />
					<br />
					<Button  id="removeItem" className="demoButton" onClick={this.handleRemoveItemClick.bind(this)}>Remove "1"</Button>
					<br />
					<br />
					<CheckBox  id="sorted" onChange={this.handleSortedChange.bind(this)}>Sorted</CheckBox>
					<br />
					<br />
					<CheckBox  id="autoSort" checked onChange={this.handleAutoSortChange.bind(this)}>Auto sort</CheckBox>
