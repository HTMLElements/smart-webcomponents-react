...
class App extends React.Component {
	...
	render() {
		return (
			<div>
				<Tree id="tree1" filterable showLines showRootLines sortDirection="asc"
				...
				<br />
				<br />
				<Tree filterable showLines showRootLines sortDirection="desc"
					sorted toggleElementPosition="near">
					<TreeItemsGroup expanded>Numbers
			            <TreeItem>2</TreeItem>
						<TreeItem>3</TreeItem>
				...
				<br />
				<br />
				<Tree filterable showLines showRootLines sort={this.customSortingFunction}
					sorted toggleElementPosition="near">
					<TreeItemsGroup expanded>Numbers
			            <TreeItem>2</TreeItem>
						<TreeItem>3</TreeItem>
