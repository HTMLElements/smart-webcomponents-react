				...
				<div className="options">
					...
					<div className="option">
						<div>
							...
							<br />
							<RadioButton  id="one" onChange={this.handleOneChange.bind(this)}>One</RadioButton>
							<br />
							<RadioButton  id="zeroOrOne" onChange={this.handleZeroOrOneChange.bind(this)}>Zero or one</RadioButton>
							<br />
							<RadioButton  id="zeroOrMany" checked onChange={this.handleZeroOrManyChange.bind(this)}>Zero or many</RadioButton>
							<br />
							<RadioButton id="oneOrMany" onChange={this.handleOneOrManyChange.bind(this)}>One or many</RadioButton>
							<br />
							<RadioButton  id="oneOrManyExtended" onChange={this.handleOneOrManyExtendedChange.bind(this)}>One or many extended</RadioButton>
							<br />
							<RadioButton id="checkBox" onChange={this.handleCheckBoxChange.bind(this)}>Checkbox</RadioButton>
							<br />
							<RadioButton id="radioButton" onChange={this.handleRadioButtonChange.bind(this)}>Radio button</RadioButton>
						</div>
						<br />
						<div>
							<p>Toggle mode:</p>
							<RadioButton id="dblclick" checked onChange={this.handleDblclickChange.bind(this)}>Item double click</RadioButton>
							<br />
							<RadioButton id="click" onChange={this.handleClickChange.bind(this)}>Item click</RadioButton>
							<br />
							<RadioButton id="arrow" onChange={this.handleArrowChange.bind(this)}>Item arrow click</RadioButton>
						</div>
					</div>
				</div>
			</div>
