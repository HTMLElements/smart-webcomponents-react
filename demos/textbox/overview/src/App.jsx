      ...
      templateContainer.current.innerHTML = `
        <template id="itemTemplate">
          <div class="templateContainer">
            <div class="primaryAction"><i class="material-icons"></i>{{ label }}</div>
      ...
      <div>
        <section>
          <div>
            ...
            <div className="module">
              <h3>Usage</h3>
              <p>
                Text fields validate input, help users fix errors, autocomplete words,
        ...
        <section id="text-box-principles">
          ...
          <div className="module module-wide">
            <h2>Identifiable</h2>
            <p>
              Using a tappable touch target, text fields should indicate that users
            ...
            <h2>Legible</h2>
            <p>
              Text fields should indicate their state – whether enabled or disabled,
              empty or filled, valid or invalid – with clear label, input, and assistive text.
            </p>
          </div>
        </section>
        ...
        <section id="text-box-layout">
          ...
          <div>
            <div className="module">
              <h2>Label</h2>
              <p>
                Text field labels display the type of input a field requires. Every text
          ...
          <div>
            ...
            <div className="module">
              <div className="light-theme" id="optionalExample">
                ...
                <ComboBox id="layoutProductCategory" className="material animation" placeholder="Product category">
