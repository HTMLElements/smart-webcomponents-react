        ...
        <div>
            <Tabs className="scroll" selectedIndex={0} tabLayout="scroll">
                <TabItem label="Bengal tiger">
                    <div className="demoContainer tabsContent">
                        The Bengal tiger (<em>Panthera tigris tigris</em>) is the most numerous
                ...
                <TabItem label="Indochinese tiger">
                    <div className="demoContainer tabsContent">
                        The Indochinese tiger (<em>Panthera tigris corbetti</em>) is a tiger subspecies
                ...
                <TabItem label="Malayan tiger">
                    <div className="demoContainer tabsContent">
                        The Malayan tiger (<em>Panthera tigris jacksoni</em>) is a tiger subspecies
                ...
                <TabItem label="Siberian tiger">
                    <div className="demoContainer tabsContent">
                        The Siberian tiger (<em>Panthera tigris altaica</em>), also called Amur
            ...
            <Tabs className="dropdown" selectedIndex={1} tabLayout="dropDown">
                <TabItem label="Asiatic lion">
                    <div className="demoContainer tabsContent">
                        The Asiatic lion (<em>Panthera leo persica</em>), also known as the Indian
                ...
                <TabItem label="West African lion">
                    <div className="demoContainer tabsContent">
                        The West African lion (<em>Panthera leo senegalensis</em>), also called
                ...
                <TabItem label="Ethiopian lion">
                    <div className="demoContainer tabsContent">
                        The Ethiopian lion (<em>Panthera leo roosevelti</em> syn. <em>Panthera leo abyssinica</em>),
                ...
                <TabItem label="Masai lion">
                    <div className="demoContainer tabsContent">
                        The Masai lion or East African lion (<em>Panthera leo nubica</em> syn. <em>Panthera leo massaica</em>)
            ...
            <Tabs className="shrink" selectedIndex={3} tabLayout="shrink">
                ...
                <TabItem label="Iberian lynx">
                    ...
                    <div className="demoContainer tabsContent">
                        <img className="tabsDemoImage" src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/69/Iberian_lynx%2C_Parque_Natural_de_la_Despe%C3%B1aperros_02.jpg/220px-Iberian_lynx%2C_Parque_Natural_de_la_Despe%C3%B1aperros_02.jpg" />
                    </div>
                </TabItem>
                <TabItem label="Bobcat">
                    <div className="demoContainer tabsContent">
                        The bobcat (<em>Lynx rufus</em>) is a North American cat that appeared
                        during the Irvingtonian stage of around 1.8 million years ago. Containing
                        12 recognized subspecies, it ranges from southern Canada to central Mexico.
                    </div>
                    <div className="demoContainer tabsContent">
                        <img className="tabsDemoImage" src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f8/Bobcat_with_kitten_2.jpg/220px-Bobcat_with_kitten_2.jpg" />
                    </div>
                </TabItem>
            </Tabs>
