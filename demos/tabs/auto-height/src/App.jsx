  ...
  return (
    <div>
      <Tabs className="auto-height" selectedIndex={1}>
        <TabItem label="TAB 1">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed ornare vehicula
          ...
          tellus ipsum, ullamcorper iaculis nisl blandit et.
        </TabItem>
        <TabItem label="TAB 2">Lorem ipsum</TabItem>
        <TabItem label="TAB 3">Lorem ipsum nec molestie massa</TabItem>
        <TabItem label="TAB 4">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras rutrum eu
          ...
          <br />
          Phasellus nec molestie massa, eget auctor eros. Nullam ante mauris, accumsan
