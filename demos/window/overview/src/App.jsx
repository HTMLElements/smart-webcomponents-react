    ...
    if (templateContainer.current) {
      templateContainer.current.innerHTML = `
        ...
        <template id="footerTemplateLight">
          <div class="footerTemplateContainer">
            <smart-button class="flat">CANCEL</smart-button>
            <smart-button class="flat">DISCARD</smart-button>
          </div>
        </template>
        <template id="footerTemplateAgreenment">
          <div class="footerTemplateContainer">
            <smart-button class="flat">DISAGREE</smart-button>
            <smart-button class="flat">AGREE</smart-button>
          </div>
        </template>
      `;
    }
      ...
      <div className="smart-demo-container">
        <div id="materialWindowContainer">
          <section>
            <div>
              ...
              <div className="module">
                <p>Windows contain text and UI controls. They retain focus until dismissed or a required action has been taken. Use windows sparingly because they are interruptive.</p>
              ...
              <div className="module">
                <h3>Behavior</h3>
                <p>Windows should never be obscured, either by other elements or the screen edge. Dialogs are dismissed when a required action has been taken.</p>
          ...
          <section id="appearance">
            ...
            <div className="module">
              <p><strong>Header</strong> section is optional. It can contain an arbitrary text or other Custom Elements.</p>
              <p>By default, the header section contains the label of the Window. The label can be changed by setting the <strong>label</strong> property.</p>
              <p>The content of the Header section can be completely replaced using an HTMLTemplate. In order to do that the user has to apply the id of an HTML Template to the <strong>headerTemplate</strong> property.</p>
            </div>
            <div className="module">
            ...
            <div className="module">
              <p><strong>Content</strong> section holds the main information presented to the user. It can contain any HTML.</p>
              <p>When the window is collapsed the content is hidden. The only visible section if the Header.</p>
            </div>
            <div className="module">
            ...
            <div className="module">
              <p><strong>Footer</strong> section is optional. It can contain an arbitrary text or other Custom Elements.</p>
              <p>Usually used to hold the Dialog interaction controls.</p>
            </div>
            <div className="module confirmation-window2">
              <Window className="content-window animation" opened pinned label="Permissions" footerTemplate="footerTemplate">
            ...
            <div className="module confirmation-window">
              <Window className="content-window animation" opened pinned label="Phone ringtone" footerTemplate="footerTemplate">
                <ListBox selectionMode="radioButton">
            ...
            <div className="module window-themes">
              ...
              <p>Use header bar windows only for high-risk situations, such as the potential loss of connectivity. Users should be able to understand the choices based on the header and button text alone.</p>
            ...
            <div className="module window-themes window-with-header-themes2">
              <Window className="content-window animation" opened pinned label="Use Google's location service?" footerTemplate="footerTemplateAgreenment">
          ...
          <section id="behavior">
            ...
            <div className="module">
              ...
              <p>Modal windows disable background interaction while opened.</p>
            </div>
            <div className="module window-themes window-modal">
              <Window className="content-window animation" opened pinned modal footerTemplate="footerTemplateLight">
                <p>Discard draft ?</p>
              </Window>
            </div>
            <div className="module"></div>
            <div className="module">
              <h2>Pinned</h2>
              <p>Pinned Windows can't be dragged. They are used for alerts or dialogs. By default <strong>pinned</strong> property is not applied. The Header section of the element is the window's draggable area.</p>
            </div>
            <div className="module window-themes window-modal unpinned">
              <Window className="content-window animation" opened label="Hi" footerTemplate="footerTemplateLight">
            ...
            <div className="module">
              <h2>Resizable</h2>
              <p>Resizable Windows can be resized from any direction. By default <strong>resizeMode</strong> property is not set.</p>
            ...
            <div className="module window-themes window-modal scrollable-content">
              <Window className="content-window animation" opened resizeMode="both" label="Resizable Window">
                <div>
                  ...
                  <p>Dialogs may be dismissed either by tapping outside of the dialog, or tapping the system back button (on Android). Alternatively, the user’s ability to dismiss a dialog may be disabled, so that one of the actions must be chosen before proceeding.</p>
                </div>
              </Window>
            </div>
            <div className="module">
              <h2>Header Controls</h2>
              <p>The header section of the Window element contains the control buttons used to do operations like maximizing, minimizing, closing, collapsing and etc.</p>
              <p>Those operations can be executed programmatically as well by calling the appropriate method.</p>
            </div>
            <div className="module window-themes window-modal header-controls">
              <Button className="open-window-button">Open</Button>
              <Window className="content-window animation" opened resizable label="Albums">
                <img src="https://www.htmlelements.com/demos/images/albums_pop.png" alt="Albums" />
              </Window>
            </div>
            <div className="module window-themes window-modal header-controls dark">
              <Button className="open-window-button">Open</Button>
              <Window className="content-window animation" opened resizable maximized label="Albums">
                <Tabs className="animation padding">
                  <TabItem label="Pop">
                    <img src="https://www.htmlelements.com/demos/images/albums_pop.png" alt="Pop Albums" />
                  </TabItem>
                  <TabItem label="Alternative">
                    <img src="https://www.htmlelements.com/demos/images/albums_alternative.png" alt="Alternative Albums" />
                  </TabItem>
                  <TabItem label="Rock">
                    <img src="https://www.htmlelements.com/demos/images/albums_rock.png" alt="Rock Albums" />
                  </TabItem>
                  <TabItem label="R & B">
                    <img src="https://www.htmlelements.com/demos/images/albums_rnb.png" alt="R & B Albums" />
                  </TabItem>
                </Tabs>
              </Window>
            </div>
