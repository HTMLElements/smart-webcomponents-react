...
export default function App() {
	...
	useEffect(() => {
		...
		setTimeout(() => {
			const state = ganttChart.current.getState()
			states[0] = state
		}, 100)
	...
	return (
		<div>
			...
			></GanttChart>
			<div ref={headerTemplateRef} className="header-controls">
				<div className="zooming" id="zoomingContainer">
				...
				<div className="resource-view" id="viewButtonContainer">
					<Button onClick={handleHeaderButtonClick} id="view">Show Resource View</Button>
				</div>
				<div className="actions" id="actionsContainer">
