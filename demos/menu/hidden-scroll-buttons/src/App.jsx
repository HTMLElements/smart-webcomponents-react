...
const App = () => {
    return (
        <div>
            <p>overflow: 'auto'</p>
            <Menu id="menu1" dropDownAppendTo="body" overflow="auto">
                <MenuItemsGroup>
                    File
            ...
            <p>overflow: 'hidden'</p>
            <Menu id="menu2" dropDownAppendTo="body" overflow="hidden">
                <MenuItemsGroup>
                    File
                    <MenuItem shortcut="Ctrl+N">New</MenuItem>
                    <MenuItem shortcut="Ctrl+0">Open</MenuItem>
            ...
            <p>overflow: 'scroll'</p>
            <Menu id="menu3" dropDownAppendTo="body" overflow="scroll">
                <MenuItemsGroup>
                    File
                    <MenuItem shortcut="Ctrl+N">New</MenuItem>
                    <MenuItem shortcut="Ctrl+0">Open</MenuItem>
