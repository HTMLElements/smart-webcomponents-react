...
function App(props) {
    const menu1Container = useRef(null);
    const menu = useRef(null);

    useEffect(() => {
        const menu1ContainerEl = menu1Container.current;
        const menu1 = menu.current;
        ...
        const contextMenuHandler = function (event) {
            ...
            if (menu1ContainerEl.contains(target)) {
