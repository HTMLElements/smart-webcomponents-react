...
const App = () => {
  ...
  const handleClickChange = () => {
    if (menu.current) {
      menu.current.selectionMode = 'click';
    }
  };

  const handleMouseenterChange = () => {
    if (menu.current) {
      menu.current.selectionMode = 'mouseenter';
    }
  };
  ...
  return (
    <div>
      ...
      <div className="options">
        ...
        <RadioButton checked onChange={handleClickChange}>On click</RadioButton>
        <RadioButton onChange={handleMouseenterChange}>On mouseenter</RadioButton>
      </div>
    </div>
  );
};
