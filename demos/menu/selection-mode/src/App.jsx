		...
		return (
			<div>
				...
				<div className="options">
					...
					<RadioButton  checked onChange={this.handleClickChange.bind(this)}>On click</RadioButton>
					<RadioButton  onChange={this.handleMouseenterChange.bind(this)}>On mouseenter</RadioButton>
				</div>
			</div>
		);
	}
